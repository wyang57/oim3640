<!-- Learning Log MP5 Job Quiz 2.0 -->

<!-- Entry 1 Project Setup -->
I created the project folder and wrote the proposal. I added the README and the first log entry. I chose the O*NET API because it fits the idea and keeps the project simple enough to finish.
